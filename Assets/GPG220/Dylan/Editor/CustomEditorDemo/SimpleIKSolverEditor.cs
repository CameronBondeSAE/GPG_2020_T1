...
public class SimpleIKSolverEditor : Editor
{
    public override void OnInspectorGUI()
    {
        ...
        if (s.pivot == null || s.upper == null || s.lower == null | s.effector == null || s.tip == null)
            EditorGUILayout.HelpBox("Please assign Pivot, Upper, Lower, Effector and Tip transforms.",
                MessageType.Error);
        base.OnInspectorGUI();
    }

    private static GUIStyle errorBox;
    ...
    static void OnDrawGizmosSelected(SimpleIKSolver siks, GizmoType gizmoType)
    {
        ...
        Handles.DrawPolyLine(siks.pivot.position, siks.upper.position, siks.lower.position, siks.effector.position,
            siks.tip.position);
